...
<script>
import speakerImage1 from '@/assets/img/pages/conferees/speakers/speaker.png';
import speakerImage2 from '@/assets/img/pages/conferees/speakers/spekaer1.png';
import speakerImage3 from '@/assets/img/pages/conferees/speakers/speaker2.png';
...
@import '@/assets/css/styles/pages/conferees/principal-speaker.css';
</style>