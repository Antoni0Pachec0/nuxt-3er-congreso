...
import RobertoSpeaker from "@/assets/img/pages/conferees/speakers/roberto-speaker.png";
import ElenaSpeaker from "@/assets/img/pages/conferees/speakers/elena-speaker.png";
