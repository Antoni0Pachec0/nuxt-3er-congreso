...
<script setup>
import mapa from '@/assets/img/pages/map.webp'
import laptop from '@/assets/img/pages/lap.webp'      
import mascota from '@/assets/img/pages/mascota.webp' 
import '@/assets/css/styles/pages/location-uni.css'
